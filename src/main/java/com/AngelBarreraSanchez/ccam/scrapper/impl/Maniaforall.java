 ...
 * Get a Cline from http://maniaforall.no-ip.org/index.php
 * @author Angel Barrera Sanchez
 */
public class Maniaforall implements FreeClinesScrapper {
	private String BASE_URL = "http://maniaforall.no-ip.org/index.php";
	 ...
	 * @param default_hops
	 */
	public Maniaforall(String default_hops) {
