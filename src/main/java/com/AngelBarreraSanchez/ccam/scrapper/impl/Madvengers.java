 ...
 * Get a Cline from http://madvengers-cccam.com/verif.php
 * @author Angel Barrera Sanchez
 */
public class Madvengers implements FreeClinesScrapper {
	private String BASE_URL = "http://madvengers-cccam.com/verif.php";
	 ...
	 * @param default_hops
	 */
	public Madvengers(String default_hops) {
	...
	public List<CCCAMEntity> getLines() {
		...
		try {
			...
			Response res = Jsoup.connect("http://madvengers-cccam.com/js/contact_me.js")
