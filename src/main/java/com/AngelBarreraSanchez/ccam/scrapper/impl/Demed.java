 ...
 * Get a Cline from http://demed.no-ip.org/index.php
 * @author Angel Barrera Sanchez
 */
public class Demed implements FreeClinesScrapper {
	private String BASE_URL = "http://demed.no-ip.org/index.php";
	 ...
	 * @param default_hops
	 */
	public Demed(String default_hops) {
