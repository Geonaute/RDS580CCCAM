 ...
 * Get a Cline from http://speed.cccam.bz/iiii/cccam.php
 * @author Angel Barrera Sanchez
 */
public class SpeedCam implements FreeClinesScrapper {
	private String BASE_URL = "http://speed.cccam.bz/iiii/cccam.php";
	 ...
	 * @param default_hops
	 */
	public SpeedCam(String default_hops) {
